  ...
  return (
    <ContAccordion>
      ...
      >
        ...
        <AccordionsDetails>
          <Typography variant="body1">
            Так, ми гарантуємо високий рівень захисту ваших особистих даних. Вся
            інформація передається через захищені з´єднання, і ми не передаємо
            ваши дані третім особам.
          </Typography>
        </AccordionsDetails>
      </Accordions>
      <Accordions
      ...
      >
        ...
        <AccordionsDetails>
          <Typography variant="body1">
            Так, наші спеціалісти будуть надсилати вам сповіщення щодо термінів
      ...
      >
        ...
        <AccordionsDetails>
          <Typography variant="body1">
            ...
            (Паспорт, посвідчення водія, ID-карта). Також потрібно вказати дані
      ...
      >
        ...
        <AccordionsDetails>
          <Typography variant="body1">
            ...
            потрібно мати всі необхідні документи та інформацію про цю особу та
      ...
      >
        ...
        <AccordionsDetails>
          <Typography variant="body1">
            Наразі ми працюємо над створенням мобільного додатку і сподіваємось
            запустити його найближчим часом. Тим часом ви можете використовувати
            нашу веб-платформу з будь-якого пристрою з доступом до Інтернету.
          </Typography>
        </AccordionsDetails>
      </Accordions>
    </ContAccordion>
